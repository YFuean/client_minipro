// pages/xiaoyuankacongzhi/xiaoyuankacongzhi.js
...
Page({
     ...
     API.cardDeposit({
      ...
      money:this.data.addMoney
       ...
       if(data.code===1){
        ...
        this.setData({
          myBalance:this.data.myBalance + this.data.addMoney
        })
       app.globalData.myBalance = this.data.myBalance
       }else{
         wx.showToast({
           title: '充值失败',
         })
  ...
  onShow: function () {
    this.setData({
      ...
      myBalance: app.globalData.myBalance,
